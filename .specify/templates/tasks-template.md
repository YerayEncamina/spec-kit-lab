...
**Tests**: The examples below include test tasks. Tests are REQUIRED - include unit tests for each user story unless explicitly not applicable, and document the rationale.
